...
var publicApiProjectPath = sourcesDirPath.CombineWithFilePath("src/csharp/core/TickTrader.Algo.Server.PublicAPI.NetFxClient/TickTrader.Algo.Server.PublicAPI.NetFxClient.csproj");
