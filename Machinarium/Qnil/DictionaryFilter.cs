...
{
    internal class DictionaryFilter<TKey, TValue> : OperatorBase, IDynamicDictionarySource<TKey, TValue>
    {
        ...
        public DictionaryFilter(IDynamicDictionarySource<TKey, TValue> src, Func<TKey, TValue, bool> condition)
        {
            this.src = src;
