...
namespace TickTrader.Algo.Protocol.Grpc.Lib {
    ...
    static ConfigReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "X25hbWUYASABKAkiqwEKBUlucHV0EhcKD3NlbGVjdGVkX3N5bWJvbBgBIAEo",
            "CRI+CgVxdW90ZRgKIAEoCzItLlRpY2tUcmFkZXIuQWxnby5Qcm90b2NvbC5H",
            "cnBjLkxpYi5RdW90ZUlucHV0SAASQAoGbWFwcGVkGAsgASgLMi4uVGlja1Ry",
            "YWRlci5BbGdvLlByb3RvY29sLkdycGMuTGliLk1hcHBlZElucHV0SABCBwoF",
            "aW5wdXQiHAoKUXVvdGVJbnB1dBIOCgZ1c2VfbDIYASABKAgikwMKC01hcHBl",
            "ZElucHV0EkcKEHNlbGVjdGVkX21hcHBpbmcYASABKAsyLS5UaWNrVHJhZGVy",
            "LkFsZ28uUHJvdG9jb2wuR3JwYy5MaWIuTWFwcGluZ0tleRJGCgpiYXJfdG9f",
            "YmFyGAogASgLMjAuVGlja1RyYWRlci5BbGdvLlByb3RvY29sLkdycGMuTGli",
            "LkJhclRvQmFySW5wdXRIABJMCg1iYXJfdG9fZG91YmxlGAsgASgLMjMuVGlj",
            "a1RyYWRlci5BbGdvLlByb3RvY29sLkdycGMuTGliLkJhclRvRG91YmxlSW5w",
            "dXRIABJKCgxxdW90ZV90b19iYXIYDCABKAsyMi5UaWNrVHJhZGVyLkFsZ28u",
            "UHJvdG9jb2wuR3JwYy5MaWIuUXVvdGVUb0JhcklucHV0SAASUAoPcXVvdGVf",
            "dG9fZG91YmxlGA0gASgLMjUuVGlja1RyYWRlci5BbGdvLlByb3RvY29sLkdy",
            "cGMuTGliLlF1b3RlVG9Eb3VibGVJbnB1dEgAQgcKBWlucHV0Ig8KDUJhclRv",
            "QmFySW5wdXQiEgoQQmFyVG9Eb3VibGVJbnB1dCIRCg9RdW90ZVRvQmFySW5w",
            "dXQiFAoSUXVvdGVUb0RvdWJsZUlucHV0IkYKC091dHB1dENvbG9yEg0KBWFs",
            "cGhhGAEgASgCEgsKA3JlZBgCIAEoAhINCgVncmVlbhgDIAEoAhIMCgRibHVl",
            "GAQgASgCIqACCgZPdXRwdXQSEgoKaXNfZW5hYmxlZBgBIAEoCBJCCgpsaW5l",
            "X2NvbG9yGAIgASgLMi4uVGlja1RyYWRlci5BbGdvLlByb3RvY29sLkdycGMu",
            "TGliLk91dHB1dENvbG9yEhYKDmxpbmVfdGhpY2tuZXNzGAMgASgFEkwKDGNv",
            "bG9yZWRfbGluZRgKIAEoCzI0LlRpY2tUcmFkZXIuQWxnby5Qcm90b2NvbC5H",
            "cnBjLkxpYi5Db2xvcmVkTGluZU91dHB1dEgAEk4KDW1hcmtlcl9zZXJpZXMY",
            "CyABKAsyNS5UaWNrVHJhZGVyLkFsZ28uUHJvdG9jb2wuR3JwYy5MaWIuTWFy",
            "a2VyU2VyaWVzT3V0cHV0SABCCAoGb3V0cHV0ImMKEUNvbG9yZWRMaW5lT3V0",
            "cHV0Ek4KCmxpbmVfc3R5bGUYAiABKA4yOi5UaWNrVHJhZGVyLkFsZ28uUHJv",
            "dG9jb2wuR3JwYy5MaWIuQXBpRGVzY3JpcHRvci5MaW5lU3R5bGUiZgoSTWFy",
            "a2VyU2VyaWVzT3V0cHV0ElAKC21hcmtlcl9zaXplGAIgASgOMjsuVGlja1Ry",
            "YWRlci5BbGdvLlByb3RvY29sLkdycGMuTGliLkFwaURlc2NyaXB0b3IuTWFy",
            "a2VyU2l6ZSI8ChFQbHVnaW5QZXJtaXNzaW9ucxIVCg10cmFkZV9hbGxvd2Vk",
            "GAEgASgIEhAKCGlzb2xhdGVkGAIgASgIIrMECgxQbHVnaW5Db25maWcSOQoD",
            "a2V5GAEgASgLMiwuVGlja1RyYWRlci5BbGdvLlByb3RvY29sLkdycGMuTGli",
            "LlBsdWdpbktleRJOCgp0aW1lX2ZyYW1lGAIgASgOMjouVGlja1RyYWRlci5B",
            "bGdvLlByb3RvY29sLkdycGMuTGliLkFwaURlc2NyaXB0b3IuVGltZUZyYW1l",
            "EhMKC21haW5fc3ltYm9sGAMgASgJEkcKEHNlbGVjdGVkX21hcHBpbmcYBCAB",
            "KAsyLS5UaWNrVHJhZGVyLkFsZ28uUHJvdG9jb2wuR3JwYy5MaWIuTWFwcGlu",
            "Z0tleRITCgtpbnN0YW5jZV9pZBgFIAEoCRJJCgtwZXJtaXNzaW9ucxgGIAEo",
            "CzI0LlRpY2tUcmFkZXIuQWxnby5Qcm90b2NvbC5HcnBjLkxpYi5QbHVnaW5Q",
            "ZXJtaXNzaW9ucxI/Cgpwcm9wZXJ0aWVzGAcgAygLMisuVGlja1RyYWRlci5B",
            "bGdvLlByb3RvY29sLkdycGMuTGliLlByb3BlcnR5EkcKCWluZGljYXRvchgK",
            "IAEoCzIyLlRpY2tUcmFkZXIuQWxnby5Qcm90b2NvbC5HcnBjLkxpYi5JbmRp",
            "Y2F0b3JDb25maWdIABJGCgl0cmFkZV9ib3QYCyABKAsyMS5UaWNrVHJhZGVy",
            "LkFsZ28uUHJvdG9jb2wuR3JwYy5MaWIuVHJhZGVCb3RDb25maWdIAEIICgZj",
            "b25maWciEQoPSW5kaWNhdG9yQ29uZmlnIhAKDlRyYWRlQm90Q29uZmlnYgZw",
            "cm90bzM="));
  ...
  public sealed partial class Input : pb::IMessage<Input> {
    ...
    public Input(Input other) : this() {
      selectedSymbol_ = other.selectedSymbol_;
    ...
    private string selectedSymbol_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public string SelectedSymbol {
      get { return selectedSymbol_; }
      set {
        selectedSymbol_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public bool Equals(Input other) {
      ...
      if (SelectedSymbol != other.SelectedSymbol) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (SelectedSymbol.Length != 0) hash ^= SelectedSymbol.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      if (SelectedSymbol.Length != 0) {
        output.WriteRawTag(10);
        output.WriteString(SelectedSymbol);
      }
    ...
    public int CalculateSize() {
      int size = 0;
      if (SelectedSymbol.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(SelectedSymbol);
      }
      if (inputCase_ == InputOneofCase.Quote) {
    ...
    public void MergeFrom(Input other) {
      ...
      if (other.SelectedSymbol.Length != 0) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            SelectedSymbol = input.ReadString();
            break;
          }
          case 82: {
  ...
  public sealed partial class PluginConfig : pb::IMessage<PluginConfig> {
    ...
    private string mainSymbol_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public string MainSymbol {
      get { return mainSymbol_; }
      set {
        mainSymbol_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public bool Equals(PluginConfig other) {
      ...
      if (MainSymbol != other.MainSymbol) return false;
      if (!object.Equals(SelectedMapping, other.SelectedMapping)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (MainSymbol.Length != 0) hash ^= MainSymbol.GetHashCode();
      if (selectedMapping_ != null) hash ^= SelectedMapping.GetHashCode();
    ...
    public int CalculateSize() {
      ...
      if (MainSymbol.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(MainSymbol);
      }
      if (selectedMapping_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(SelectedMapping);
      }
    ...
    public void MergeFrom(PluginConfig other) {
      ...
      if (other.MainSymbol.Length != 0) {
        MainSymbol = other.MainSymbol;
      }
      if (other.selectedMapping_ != null) {
        if (selectedMapping_ == null) {
          selectedMapping_ = new global::TickTrader.Algo.Protocol.Grpc.Lib.MappingKey();
