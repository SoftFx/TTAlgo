...
namespace TickTrader.Algo.Indicators.Tests.BillWilliamsTests.AwesomeOscillator
{
    public class AwesomeOscillatorTestCase : SimpleTestCase
    {
        ...
        public AwesomeOscillatorTestCase(Type indicatorType, string symbol, string quotesPath, string answerPath,
