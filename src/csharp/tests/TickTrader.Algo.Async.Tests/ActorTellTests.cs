    ...
    public class ActorTellTests
    {
        ...
        public class ProducerActor
        {
            ...
            private class Impl : Actor
            {
                ...
                private void SendMessages(SendMsgCmd cmd)
                {
        ...
        public class ConsumerActor
        {
            ...
            public void AddValue(AddValueCmd cmd) => _impl.Tell(cmd);
