...
namespace TickTrader.Algo.Core.Tests
{
    ...
    public class BarBuilderTests
    {
        ...
        public void BarVector_EmptyAppend()
        {
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 14, 00, 00), vector[0].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 15, 00, 00), vector[0].CloseTime);
        ...
        public void BarVector_Append2Bars()
        {
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 15, 00, 00), vector[1].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 16, 00, 00), vector[1].CloseTime);
        ...
        public void BarVector_MasterSlave_SlaveSkip()
        {
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 14, 00, 00), master[0].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 15, 00, 00), master[0].CloseTime);
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 16, 00, 00), master[1].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 17, 00, 00), master[1].CloseTime);
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 14, 00, 00), slave[0].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 15, 00, 00), slave[0].CloseTime);
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 16, 00, 00), slave[1].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 17, 00, 00), slave[1].CloseTime);
        ...
        public void BarVector_MasterSlave_SlaveFill()
        {
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 15, 00, 00), master[1].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 16, 00, 00), master[1].CloseTime);
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 16, 00, 00), master[2].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 17, 00, 00), master[2].CloseTime);
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 17, 00, 00), master[3].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 18, 00, 00), master[3].CloseTime);
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 18, 00, 00), master[4].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 19, 00, 00), master[4].CloseTime);
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 15, 00, 00), slave[1].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 16, 00, 00), slave[1].CloseTime);
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 16, 00, 00), slave[2].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 17, 00, 00), slave[2].CloseTime);
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 17, 00, 00), slave[3].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 18, 00, 00), slave[3].CloseTime);
            ...
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 18, 00, 00), slave[4].OpenTime);
            Assert.AreEqual(TimeMsHelper.FromDateAndTime(2015, 1, 1, 19, 00, 00), slave[4].CloseTime);
