...
{
    [TestClass]
    public class AtrTest : TestBase
    {
        private void TestMeasures(string symbol, string dir, int inpAtrPeriod)
        {
            var test = new AtrTestCase(typeof (Indicators.ATR.ATR), symbol, PathHelper.QuotesPath(dir, symbol),
                PathHelper.AnswerPath(dir, symbol, "ATR"), inpAtrPeriod);
