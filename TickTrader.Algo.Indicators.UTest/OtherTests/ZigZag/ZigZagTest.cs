...
namespace TickTrader.Algo.Indicators.UTest.OtherTests.ZigZag
{
    ...
    {
        private void TestMeasures(string symbol, string timeframe, int depth, int deviation, int backstep, double pointSize)
        {
        ...
        {
            TestMeasures("AUDJPY", "M30", 12, 5, 3, 1e-3);
        }

        [TestMethod]
        public void TestMeasuresAUDJPY_M30_32_14_5()
        {
            TestMeasures("AUDJPY", "M30", 32, 14, 5, 1e-3);
        }

        [TestMethod]
        public void TestMeasuresAUDNZD_M15_15_8_4()
        {
            TestMeasures("AUDNZD", "M15", 15, 8, 4, 1e-5);
        }

        [TestMethod]
        public void TestMeasuresAUDNZD_M15_25_7_8()
        {
            TestMeasures("AUDNZD", "M15", 25, 7, 8, 1e-5);
        }

        [TestMethod]
        public void TestMeasuresEURUSD_H1_20_15_7()
        {
            TestMeasures("EURUSD", "H1", 20, 15, 7, 1e-5);
        }
