...
namespace TickTrader.BotTerminal
{
    ...
    internal class SymbolDataManager
    {
        private CustomFeedStorage _cutomDataStorage;
        private FeedCache _onlineCacheStorage;

        public SymbolDataManager()
        {
        }

        public void InitOnlineSymbols()
        {
        }

        //public Task StartCustomStorage(string dbFolder)
        //{
        //    _cutomDataStorage = new CustomFeedStorage();
        //    _cutomDataStorage.Start(dbFolder);
        //}
