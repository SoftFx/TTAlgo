    ...
    public class TickBasedPluginSetup : PluginSetup, IPluginSetup
    {
        ...
        protected override InputSetup CreateInput(InputDescriptor descriptor)
        {
            ...
            switch (descriptor.DataSeriesBaseTypeFullName)
            {
                ...
                case "TickTrader.Algo.Api.Quote": return new QuoteToQuoteInput(descriptor, mainSymbol);
        ...
        protected override OutputSetup CreateOuput(OutputDescriptor descriptor)
        {
            ...
            if (descriptor.DataSeriesBaseTypeFullName == "System.Double")
                ...
                return new ColoredLineOutputSetup(descriptor, TickTrader.Algo.GuiModel.MsgCodes.UnsupportedPropertyType);
        }
    }
}
