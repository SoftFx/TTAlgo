...
using Concept = TickTrader.Algo.Core.DataflowConcept;
...
namespace TickTrader.Algo.Core.DataflowConcept
{
    internal class PluginContext : NoTimeoutByRefObject, IPluginActivator
    {
        ...
        public static Concept.PluginContext Create(string id, IPluginDataProvider dataProvider)
        {
        ...
        public static Concept.IndicatorContext CreateIndicator(string id, IPluginDataProvider dataProvider)
        {
            AlgoPluginDescriptor descriptor = GetDescriptorOrThrow(id);
            ...
            PluginFactory2 factory = new PluginFactory2(descriptor.AlgoClassType, dataProvider);
            return (Concept.IndicatorContext)factory.Create();
        }
    }
