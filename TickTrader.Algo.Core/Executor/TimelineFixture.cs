...
namespace TickTrader.Algo.Core
{
    internal class TimelineFixture
    {
        ...
        public TimelineFixture(Api.TimeFrames timeFrame)
        {
        ...
        public BarBoundaries GetBarBounds(DateTime time)
        {
        ...
        public BufferUpdateResult Update(BarBoundaries barBoundaries)
        {
            ...
            {
                var lastOpenTime = _timeline.Count == 0 ? DateTime.MinValue : _timeline[_timeline.Count - 1].Open;
