...
{
    [Indicator(DisplayName = "Best of the best of the best")]
    class FxCalendarIndicator : Indicator
    {
        ...
        protected override void Calculate()
        {
            if(firstRun)
            {
                ...
                streetNewsProvider.Filter.StartDate = DateTime.Now;
                streetNewsProvider.Filter.EndDate = DateTime.Now;
                streetNewsProvider.Filter.IsoCurrencyCodes = new[] { "EUR", "USD" };
