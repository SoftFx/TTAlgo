...
namespace TickTrader.Algo.Api
{
    public class TradeBot : AlgoPlugin
    {
        ...
        public OrderCmdResult ModifyOrder(string orderId, double? price, double? stopPrice, double? maxVisibleVolume = null, double? sl = null, double? tp = null, string comment = "", DateTime? expiration = null, double? volume = null, bool? ioc = null)
        {
            return context.TradeApi.ModifyOrder(false, orderId, price, stopPrice, maxVisibleVolume, sl, tp, comment, expiration, volume, ioc).Result;
        }
        ...
        public Task<OrderCmdResult> ModifyOrderAsync(string orderId, double? price, double? stopPrice, double? maxVisibleVolume = null, double? sl = null, double? tp = null, string comment = "", DateTime? expiration = null, double? volume = null, bool? ioc = null)
        {
            return context.TradeApi.ModifyOrder(true, orderId, price, stopPrice, maxVisibleVolume, sl, tp, comment, expiration, volume, ioc);
        }
